...
class ApartementPartnerController extends Controller
{
    public function index(Request $request){
        ...
        $propertiCollection = Properti::with('properti_apartement', 'foto_properti')
    ...
    public function update($slug)
    {
        ...
        return view('partner.dashboard.properti.apartement.update', compact('properti', 'salescategories'));
    }
