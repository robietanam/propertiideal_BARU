    ...
    <div class="flex justify-center items-center py-10">
        ...
        <div class="hidden lg:flex justify-center flex-1 bg-white text-black">
            <div class="max-w-lg text-center">
                <img class="object-contain w-full h-full" src="{{ asset('img/5041145.jpg') }}" alt="Authentication image" />
            </div>
        </div>
        <!-- Right Pane -->
        <div class="px-6 md:px-0 w-full lg:w-1/2 flex justify-center">
            <div class="max-w-md w-full">
                <div class="flex mt-20 items-center justify-center gap-y-10 py-2">
                ...
                <a href="{{ route('auth.google') }}"
                    class="flex items-center justify-center gap-3 bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-3 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
