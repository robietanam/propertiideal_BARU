...
<div class="bg-white py-12">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
        <h2 class="text-base font-semibold leading-7 text-blue-100 bg-blue-600 px-3 rounded-lg uppercase mb-4 lg:mb-8">
          Key Features</h2>
        <h1 class="lg:text-7xl text-4xl md:text-5xl font-bold tracking-tight text-gray-900 text-center">Meyediakan Layanan Properti
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900">Sesuai Kebutuhan Anda</span>
        </h1>
      </div>
  ...
  <section class="max-w-5xl mx-auto w-full px-10 dark:bg-gray-800 dark:text-white">
    <div class="flex items-center justify-center flex-col gap-y-2 py-5">
      ...
      <p class="text-lg font-medium text-slate-700/70 dark:text-gray-400">Discover how our service can benefit you</p>
    </div>
