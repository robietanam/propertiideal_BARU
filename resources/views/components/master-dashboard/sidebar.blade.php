<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-light" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      <img src="img/icons/properti-ideal-logo-text.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="../pages/dashboard.html">
          ...
          <span class="nav-link-text ms-1">Beli Properti</span>
        </a>
      </li>
      <li class="nav-item mt-3">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="../pages/dashboard.html">
          ...
          <span class="nav-link-text ms-1">Mitra Terdaftar</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="../pages/dashboard.html">
