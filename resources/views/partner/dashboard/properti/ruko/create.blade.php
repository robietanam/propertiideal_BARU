    ...
    <div>
        <div class="container mx-auto py-5">
            ...
            <div class="rounded-lg" x-data="{ isOpen: false }">
                ...
                <form action="{{ route('pages.dashboard.properti.ruko.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input name="luas_bangunan" id="luas_bangunan" type="text"
                                placeholder="Masukkan luas tanah" class="border p-2 rounded w-full">
                            @error('luas_tanah')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="flex gap-2 items-center">
                                <input name="latitude" id="latitude" type="number" placeholder="Latitude ruko"
                                    class="border p-2 rounded w-full">
