...
<div>
    <div class="container mx-auto py-5">
        ...
        <div class="rounded-lg">
            ...
            <form action="{{ route('pages.dashboard.properti.ruko.store') }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="mb-6 pt-4">
                        ...
                        <description class="mb-5 block text-lg font-medium text-textbase">
                            Foto tampak depan properti ruko anda
                        </description>
                        @error('foto_depan')
                    ...
                    <div class="mb-6 pt-4">
                        ...
                        <description class="mb-5 block text-lg font-medium text-textbase">
                            Foto tampak samping kiri properti ruko anda
                        </description>
                    ...
                    <div class="mb-6 pt-4">
                        ...
                        <description class="mb-5 block text-lg font-medium text-textbase">
                            Foto tampak samping kanan properti ruko anda
                        </description>
                    ...
                    <div class="mb-6 pt-4">
                        ...
                        <description class="mb-5 block text-lg font-medium text-textbase">
                            Foto tampak belakang properti ruko anda
                        </description>
                        @error('foto_belakang')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        <label class="text-lg font-medium text-textbase" for="luas_bangunan">Luas bangunan *</label>
                        <input name="luas_bangunan" id="luas_bangunan" type="text" placeholder="Masukkan luas tanah"
                            class="border p-2 rounded w-full">
                        @error('luas_tanah')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="text-lg font-medium text-textbase" for="latitude">Latitude ruko *</label>
                        <input name="latitude" id="latitude" type="text" placeholder="Latitude ruko"
                            class="border p-2 rounded w-full">
                        @error('latitude')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        <label class="text-lg font-medium text-textbase" for="longitude">Longitude ruko
                            *</label>
