...
@section('content')
    <section class="flex flex-wrap gap-2 justify-between px-6 md:px-0 mb-5">
        @if (session('error'))
            <p>{{ session('error') }}</p>
        @endif
        @if (session('success'))
        ...
        @endif
        <div>
            <h1 class="text-2xl font-bold">Properti Kos</h1>
            <p class="text-lg text-slate-500">Manajemen dan kelola produk properti kos Anda sekarang juga!</p>
        </div>
        <div>
            <a href="{{ route('pages.dashboard.properti.kos.create') }}">
    ...
    <section class="container px-6 md:px-0 mx-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center gap-x-6">
                                                <a
                                                    href="{{ route('pages.dashboard.properti.kos.update', $data['slug']) }}">
                                                    <button
                                                ...
                                                <form
                                                    action="{{ route('pages.dashboard.properti.kos.destroy', $data['slug']) }}"
                                                    method="POST"
