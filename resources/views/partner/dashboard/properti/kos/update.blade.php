    ...
    <div>
        <div class="container px-6 md:px-0 mx-auto py-5">
            ...
            <div class="rounded-lg" x-data="{ isOpen: false }">
                ...
                <form action="{{ route('pages.dashboard.properti.kos.edit', $properti->slug) }}" method="POST"
            ...
            'foto_belakang' => 'Foto Tampak Belakang',
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            <label class="text-lg font-medium text-textbase" for="luas_kamar">Luas Kamar
                                * (<span>m<sup>2</sup></span>)</label>
                            <input value="{{ optional($properti->properti_kos->first())->luas_kamar }}" name="luas_kamar"
                                id="luas_kamar" type="text" placeholder="Masukkan luas apartement"
                        ...
                        <div>
                            ...
                            <select name="jenis_kamar_mandi" id="jenis_kamar_mandi" class="border p-2 rounded w-full">
                                <option value="" disabled
                                    {{ !optional($properti->properti_kos->first())->jenis_kamar_mandi ? 'selected' : '' }}>
                                    Pilih Jenis Kamar Mandi</option>
                                <option value="Luar"
                                    {{ optional($properti->properti_kos->first())->jenis_kamar_mandi == 'Luar' ? 'selected' : '' }}>
                                    Luar</option>
                                <option value="Dalam"
                                    {{ optional($properti->properti_kos->first())->jenis_kamar_mandi == 'Dalam' ? 'selected' : '' }}>
                                    Dalam</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 items-center">
                                <input value="{{ $properti->longitude }}" name="longitude" id="longitude"
                                    type="number" placeholder="Masukkan longitude" class="border p-2 rounded w-full">
                                <svg @click="isOpen = !isOpen" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" fill="#2d2d2d" viewBox="0 0 256 256">
                                    <path
                                        d="M140,180a12,12,0,1,1-12-12A12,12,0,0,1,140,180ZM128,72c-22.06,0-40,16.15-40,36v4a8,8,0,0,0,16,0v-4c0-11,10.77-20,24-20s24,9,24,20-10.77,20-24,20a8,8,0,0,0-8,8v8a8,8,0,0,0,16,0v-.72c18.24-3.35,32-17.9,32-35.28C168,88.15,150.06,72,128,72Zm104,56A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z">
