                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            <label class="text-lg font-medium text-textbase" for="luas_kamar">Luas Kamar
                                *</label>
                            <input value="{{ optional($properti->properti_kos->first())->luas_kamar }}"
                                name="luas_kamar" id="luas_kamar" type="text"
                        ...
                        <div>
                            <label class="text-lg font-medium text-textbase" for="jenis_kamar_mandi">Jenis kamar mandi *</label>
                            <select name="jenis_kamar_mandi" id="jenis_kamar_mandi" class="border p-2 rounded w-full">
                                <option value="" disabled {{ !optional($properti->properti_kos->first())->jenis_kamar_mandi ? 'selected' : '' }}>Pilih Jenis Kamar Mandi</option>
                                <option value="Luar" {{ optional($properti->properti_kos->first())->jenis_kamar_mandi == 'Luar' ? 'selected' : '' }}>Luar</option>
                                <option value="Dalam" {{ optional($properti->properti_kos->first())->jenis_kamar_mandi == 'Dalam' ? 'selected' : '' }}>Dalam</option>
                            </select>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
