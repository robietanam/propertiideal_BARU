            ...
            <form action="{{ route('pages.dashboard.properti.rumah.store') }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input name="luas_tanah" id="luas_tanah" type="text"
                    ...
                    <div>
                        ...
                        <input name="luas_bangunan" id="luas_bangunan" type="text" placeholder="Masukkan luas_bangunan"
                            class="border p-2 rounded w-full">
                        @error('luas_bangunan')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        <label class="text-lg font-medium text-textbase" for="jumlah_garasi">Jumlah garasi
                            rumah *</label>
                        <input name="jumlah_garasi" id="jumlah_garasi" type="text"
                            placeholder="Jumlah garasi" class="border p-2 rounded w-full">
                        @error('jumlah_garasi')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
