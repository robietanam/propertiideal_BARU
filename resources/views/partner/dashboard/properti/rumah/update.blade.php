        ...
        <div class="container mx-auto px-6 md:px-0 py-5">
            ...
            <div class="rounded-lg" x-data="{ isOpen: false }">
                <h1 class ="text-3xl font-bold mb-4 text-textbase">Yuk, mulai listing properti
                    ...
                    <form action="{{ route('pages.dashboard.properti.rumah.edit', $properti->slug) }}" method="POST"
            ...
            'foto_belakang' => 'Foto Tampak Belakang',
                                ...
                                <div class="mb-6 pt-4">
                                    ...
                                    <div class="mb-5 rounded-md border border-[#e0e0e0] py-4 px-8">
                                        ...
                                        <span id="label-{{ $field }}"
                                            ...
                                            {{ optional($properti->foto_properti->where('jenis_foto_id', $loop->index + 1)->first())->foto_properti
                                                ? basename(optional($properti->foto_properti->where('jenis_foto_id', $loop->index + 1)->first())->foto_properti)
                                                : '' }}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input value="{{ optional($properti->properti_rumah->first())->luas_tanah }}"
                                    name="luas_tanah" id="luas_tanah" type="text" placeholder="Masukkan luas apartement"
                            ...
                            <div>
                                <label class="text-lg font-medium text-textbase" for="luas_bangunan">Luas Bangunan
                                    * (<span>m<sup>2</sup></span>)</label>
                                <input value="{{ optional($properti->properti_rumah->first())->luas_bangunan }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <div class="flex gap-2 items-center">
                                    <input value="{{ $properti->latitude }}" name="latitude" id="latitude" type="number"
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 items-center">
                                    <input value="{{ $properti->longitude }}" name="longitude" id="longitude"
                                        type="number" placeholder="Masukkan longitude"
                                        class="border p-2 rounded w-full">
                                    <svg @click="isOpen = !isOpen" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="#2d2d2d" viewBox="0 0 256 256">
                                        <path
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                <label class="text-lg font-medium text-textbase" for="jumlah_garasi">Jumlah garasi
                                    apartment *</label>
                                <input value="{{ optional($properti->properti_rumah->first())->jumlah_garasi }}"
                                    name="jumlah_garasi" id="jumlah_garasi" type="text"
                            ...
                            <div>
                                <label class="text-lg font-medium text-textbase" for="jumlah_kamar_tidur">Jumlah kamar
                                    tidur
                                    *</label>
                                <input value="{{ optional($properti->properti_rumah->first())->jumlah_kamar_tidur }}"
                            ...
                            <div>
                                <label class="text-lg font-medium text-textbase" for="jumlah_kamar_mandi">Jumlah kamar
                                    mandi
                                    *</label>
                                <input value="{{ optional($properti->properti_rumah->first())->jumlah_kamar_mandi }}"
