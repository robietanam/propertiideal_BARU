        ...
        <div class="w-full  lg:w-1/2 flex justify-center">
            <div class="max-w-md w-full">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-md font-medium text-gray-400 ">Yuk, masuk sebagai partner untuk mulai menjual properti Anda</p>
                </div>
                @if (session('status'))
                ...
                @endif
                <form action="{{ route('pages.partner.login.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>Belum menjadi partner? <a href="{{ route('pages.submission') }}" class="text-blue-600 hover:underline">Jadi partner
                            sekarang!</a>
                    </p>
                </div>
            </div>
