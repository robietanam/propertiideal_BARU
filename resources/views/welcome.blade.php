...
@section('content')
    ...
    <div class="flex flex-col px-6 md:px-16 py-16 gap-12 md:gap-24 bg-white">
        ...
        <div class="flex gap-12 md:gap-28 flex-wrap justify-center">
            <div class="flex flex-col text-center border rounded-3xl gap-3 pt-12 pb-6 px-6 max-w-[412px]">
            ...
            <div class="flex flex-col text-center border rounded-3xl gap-3 pt-12 pb-6 px-6 max-w-[412px]">
                ...
                <p class="text-base text-black">Dari hunian luas hingga layanan yang memudahkan proses pembelian, Properti
                    Ideal
    ...
    <div class="flex px-6 md:px-16 py-16 items-center flex-wrap justify-center md:justify-between gap-12 md:gap-24 bg-secondary-blue">
        <div class="flex flex-col items-center md:items-start text-center md:text-left gap-3">
            <p
                ...
                Sosial Media</p>
            <p class="text-2xl md:text-4xl font-semibold text-white">Ikuti Media Sosial Kami</p>
            <p class="text-sm text-white">Ikuti dan pantau terus media sosial kami agar tidak ketinggalan konten dan promo
                menarik dari kami!</p>
            <button class="text-white px-4 py-2 border border-white rounded w-fit items-center flex gap-2">
        ...
        <div class="flex flex-col text-center border rounded-3xl gap-3 pt-12 pb-6 px-6 max-w-[412px]">
            <p class="text-xl font-semibold">Properti Solution</p>
            <p class="text-base">Properti Ideal berkomitmen menyediakan layanan yang disesuaikan dengan kebutuhan Anda,
                mulai dari pembangunan rumah, renovasi, hingga desain interior, dengan solusi lengkap dari tim
                profesional kami.</p>
            <p class="text-base font-semibold text-primary-blue">Jelajai Sekarang</p>
        </div>
    ...
    <div class="flex flex-col md:flex-row px-6 md:px-16 pb-8 pt-16 items-center justify-center md:justify-between gap-12 md:gap-24 bg-white">
        <div class="flex flex-col order-last md:order-first text-center border rounded-3xl gap-3 pt-12 pb-6 px-6 max-w-[412px]">
            <p class="text-xl font-semibold">Properti Solution</p>
            <p class="text-base">Properti Ideal berkomitmen menyediakan layanan yang disesuaikan dengan kebutuhan Anda,
                mulai dari pembangunan rumah, renovasi, hingga desain interior, dengan solusi lengkap dari tim
                profesional kami.</p>
        ...
        <div class="flex flex-col flex- items-center md:items-start text-center md:text-left gap-3">
            <p class="bg-primary-blue text-white text-base font-semibold py-[2px] px-6 w-fit rounded-full text-center">
                Review</p>
            <p class="text-2xl md:text-4xl font-semibold text-black">Lihat Review Properti Lengkap</p>
            <p class="text-sm text-black">Jangan lewatkan video terbaru kami dengan ulasan lengkap berbagai properti terbaik untuk Anda!</p>
            <button class="text-black bg-primary-yellow px-4 py-2 border rounded w-fit items-center flex gap-2">
                <p class="text-sm font-semibold">Subscribe</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d" viewBox="0 0 256 256">
                    <path
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    ...
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Anda dapat mendaftar sebagai mitra penjual melalui
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Kami memerlukan mitra penjual untuk memiliki izin usaha
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Setelah menjadi mitra penjual, Anda akan mendapatkan
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Kami tidak mengenakan biaya pendaftaran atau biaya
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Pembayaran untuk transaksi akan dilakukan diluar sistem
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Ya, sebagai mitra penjual, Anda memiliki kebebasan penuh
            ...
            <li class="bg-secondary-white rounded-xl h-fit">
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                    style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed text-base px-6">Ya, kami menyediakan dukungan pemasaran dan promosi
