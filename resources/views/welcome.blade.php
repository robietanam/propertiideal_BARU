                        ...
                        <div class="relative flex mt-10 flex-col bg-white ring-1 ring-primarybase w-full mb-4 rounded-lg">
                            <div class="bg-white rounded-lg">
                                <div class="py-8 px-10">
                                    <h1
                                        class="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-textbase pr-3 text-2xl font-bold tracking-tight text-textbase sm:text-5xl">
                                        Beli properti dari rumah</h1>
                                    <p class="mt-3 text-xl leading-8 text-textbase">Kami menyediakan berbagai pilihan properti yang cocok untuk berbagai kebutuhan, mulai dari hunian pribadi hingga bisnis komersil
                                        kami bangga menjadi mitra terpercaya dalam perjalanan Anda mencari properti yang ideal.</p>
                                    <div class="mt-3 flex items-center gap-x-6">
                                        <a href="{{ route('pages.buy') }}"
                                            ...
                                            Beli properti <span aria-hidden="true">→</span>
                                        </a>
                                        <a href="{{ route('pages.buy') }}"
                                            class="rounded-md bg-white cursor-pointer ring-1 ring-primarybase px-5 py-2.5 text-sm font-semibold leading-6 text-primarybase">Jadi Sewa properti</a>
                    ...
                    <div class="grid gap-4 mt-8 sm:grid-cols-3">
                        <div class="flex items-center justify-center text-gray-800">
                            <button x-on:click="openTab = 1"
                                ...
                                <p class="text-white ml-2 font-semibold text-lg">Properti Service</p>
                            </button>
                        </div>
                        <div class="flex items-center justify-center text-gray-800">
                            <button x-on:click="openTab = 2"
                                ...
                                <p class="text-primarybase ml-2 font-semibold text-lg">Properti
                                    Ideal</p>
                            </button>
                        </div>
                        <div class="flex items-center justify-center text-gray-800">
                            <button x-on:click="openTab = 3"
                                ...
                                <p class="text-primarybase ml-2 font-semibold text-lg">Properti Solution</p>
                            </button>
                        </div>
                    </div>
                    <div
